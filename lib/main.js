...
(function() {
  ...
  this.execute = function(command, handler) {
    var exec, status, stderr, stdout, _ref;
    if (handler == null) {

      /* https://github.com/gvarsanyi/sync-exec */
      exec = require('sync-exec');
      _ref = exec('ls'), stdout = _ref.stdout, stderr = _ref.stderr, status = _ref.status;
      if ((stderr != null) && stderr.length > 0) {
        throw new Error(stderr);
      }
      return lines_from_stdout(stdout);
    }
    (require('child_process')).exec(O['on-change'], (function(_this) {
