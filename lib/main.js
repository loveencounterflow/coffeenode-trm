(function() {
  var ANALYZER, TYPES, color_code, color_name, effect_name, effect_names, effect_off, effect_on, isa_text, lines_from_stdout, rainbow_color_names, rainbow_idx, _fn, _fn1, _ref, _rpr,
    __slice = [].slice,
    _this = this;
  ...
  this.dir = function() {
    ...
    if (r.length > width) {
      r = r.slice(0, +(width - 4) + 1 || 9e9).concat(this.grey(' ...'));
    }
